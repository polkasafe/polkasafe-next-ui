...
const SelectTransactionType = ({
	...
	return (
		<div className='w-[560px]'>
			<h2 className='font-semibold text-md leading-[22px] text-white mb-4'>Select Transaction Type</h2>
			<Dropdown
				trigger={['click']}
			...
			>
				<div className='flex justify-between gap-x-4 items-center text-white text-[16px]'>
					<span className='flex items-center gap-x-2'>{transactionType}</span>
