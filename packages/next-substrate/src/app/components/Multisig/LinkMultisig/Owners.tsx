						...
						{signatories.length && multisigThreshold ? (
							<>
								<p className='text-text_secondary mb-3'>
									This safe on <span className='text-white capitalize'>{network}</span> has {signatories?.length}{' '}
									...
									>
										...
										<div className='flex items-center'>
											...
											<div className='flex ml-3'>
												...
												<button onClick={() => copyText(item.address, true, network)}>
							...
							<>
								<p className='text-text_secondary mb-3'>
									We cannot find this Multisig or multisig is not on-chain (it should have a existential balance and at
									least one transaction), Please enter the Signatories and threshold of this Multisig.
								</p>
								...
								<Form.Item
									...
									rules={[{ required: true }]}
									help={
										(threshold < 2 || threshold > signatoriesArray.length) &&
										'Threshold Must Be Atleast 2 And Less Than Signatories.'
									}
