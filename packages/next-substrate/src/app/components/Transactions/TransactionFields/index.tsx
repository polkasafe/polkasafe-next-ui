...
const TransactionFields = ({
	...
	const { isOwnerOfMultisig } = useCheckForOwner(multisigAddress);
		...
		<div>
			...
			{isOwnerOfMultisig ? (
				...
				<div className='flex max-w-full gap-x-2'>
					...
					<Tooltip
						title={<span className='text-text_secondary text-xs flex gap-x-2 items-center'>You are not the Owner</span>}
					>
						<WarningCircleIcon className='text-base' />
					</Tooltip>
				</div>
