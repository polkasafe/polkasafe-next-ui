			...
			<div className='w-fit text-sm m-5 overflow-auto [&::-webkit-scrollbar]:hidden'>
				<p className='text-white text-sm'>
					...
					<p>
						...
						regards to the information that they shared and/or collect in Website Name. This policy is not applicable to
					...
					<ul className='mt-2 list-inside'>
						...
						<li>
							...
							provide you with updates and other <br /> information relating to the website, and for marketing and
