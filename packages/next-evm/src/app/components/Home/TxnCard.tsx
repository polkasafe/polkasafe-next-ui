...
import NoTransactionsHistory from '@next-common/assets/icons/no-transaction.svg';
import NoTransactionsQueued from '@next-common/assets/icons/no-transactions-queued.svg';
