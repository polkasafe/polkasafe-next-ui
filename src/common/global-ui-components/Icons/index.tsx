...
import AddSVG from '@common/assets/icons/add.svg';
import AddBoxSVG from '@common/assets/icons/add-box.svg';
import AddressBookSVG from '@common/assets/icons/address-book.svg';
import ExchangeSVG from '@common/assets/icons/Exchange.svg';
import AppsSVG from '@common/assets/icons/apps.svg';
import ArrowDownLeftSVG from '@common/assets/icons/arrow-down-left.svg';
import ArrowRightSVG from '@common/assets/icons/arrow-right.svg';
import ArrowUpRightSVG from '@common/assets/icons/arrow-up-right.svg';
import AssetsSVG from '@common/assets/icons/assets.svg';
import BellIconSVG from '@common/assets/icons/bell-icon.svg';
import BrainSVG from '@common/assets/icons/brain-icon.svg';
import ChainSVG from '@common/assets/icons/chain-icon.svg';
import CheckOutlinedSVG from '@common/assets/icons/CheckOutlined.svg';
import Circle3DotsSVG from '@common/assets/icons/circle-3-dots.svg';
import CircleArrowDownSVG from '@common/assets/icons/circle-arrow-down.svg';
import CircleArrowUpSVG from '@common/assets/icons/circle-arrow-up.svg';
import CircleCheckSVG from '@common/assets/icons/circle-check.svg';
import CirclePlusSVG from '@common/assets/icons/circle-plus.svg';
import CircleWatchSVG from '@common/assets/icons/circle-watch.svg';
import CloseSVG from '@common/assets/icons/close-icon.svg';
import CopySVG from '@common/assets/icons/copy.svg';
import CopyGreySVG from '@common/assets/icons/copy-icon-grey.svg';
import CreateMultisigSVG from '@common/assets/icons/createMultisig.svg';
import DashDotSVG from '@common/assets/icons/dash-dot.svg';
import DatePickerSVG from '@common/assets/icons/date-picker-icon.svg';
import DeleteSVG from '@common/assets/icons/delete.svg';
import DiscSVG from '@common/assets/icons/disc.svg';
import DiscordIconSVG from '@common/assets/icons/discord-icon.svg';
import DocsSVG from '@common/assets/icons/document.svg';
import DollarSVG from '@common/assets/icons/dollar.svg';
import DonateSVG from '@common/assets/icons/donate.svg';
import EditSVG from '@common/assets/icons/edit.svg';
import ElementIconSVG from '@common/assets/icons/element-icon.svg';
// import ExchangeSVG from '@common/assets/icons/Exchange.svg';
import ExportArrowSVG from '@common/assets/icons/export-arrow.svg';
import ExternalLinkSVG from '@common/assets/icons/external-link.svg';
import HomeSVG from '@common/assets/icons/home.svg';
import ImportArrowSVG from '@common/assets/icons/import-arrow.svg';
import KeySVG from '@common/assets/icons/key.svg';
import LineSVG from '@common/assets/icons/line.svg';
import LinkSVG from '@common/assets/icons/link.svg';
import MailIconSVG from '@common/assets/icons/mail-icon.svg';
import MenuSVG from '@common/assets/icons/menu.svg';
import MultisigLockSVG from '@common/assets/icons/multisig-lock.svg';
import NoNotificationSVG from '@common/assets/icons/no-notification.svg';
import NoQueuedTransactionSVG from '@common/assets/icons/no-queued-transaction.svg';
import NoTransactionSVG from '@common/assets/icons/no-transaction.svg';
import NotificationSVG from '@common/assets/icons/notification.svg';
import NotifyMailSVG from '@common/assets/icons/notify-mail.svg';
import OutlineCheckSVG from '@common/assets/icons/outline-check.svg';
import OutlineCloseSVG from '@common/assets/icons/outline-close.svg';
import PasswordFilledSVG from '@common/assets/icons/password-filled.svg';
import PasswordOutlinedSVG from '@common/assets/icons/password-outlined.svg';
import PasteSVG from '@common/assets/icons/paste-icon.svg';
import PencilSVG from '@common/assets/icons/pencil.svg';
import PencilNotificationSVG from '@common/assets/icons/pencil-notification.svg';
import PolkadotLogoTextSVG from '@common/assets/icons/polkadot-logo-text.svg';
import PolkasafeSVG from '@common/assets/icons/polkasafe.svg';
import PolkasafeLogoSVG from '@common/assets/icons/polkasafe-logo.svg';
import PolkasafeTextSVG from '@common/assets/icons/polkasafe-text.svg';
import PSSVG from '@common/assets/icons/ps-icon.svg';
import QRSVG from '@common/assets/icons/qr.svg';
import QuickbooksLogoSVG from '@common/assets/icons/quickbooks-logo.svg';
import RightArrowOutlinedSVG from '@common/assets/icons/RightArrowOutlined.svg';
import SearchSVG from '@common/assets/icons/search.svg';
import SettingsSVG from '@common/assets/icons/settings.svg';
import ShareSVG from '@common/assets/icons/share-icon.svg';
import SharedIconSVG from '@common/assets/icons/Shared.svg';
import SlackIconSVG from '@common/assets/icons/slack-icon.svg';
import SquareDownArrowSVG from '@common/assets/icons/square-down-arrow.svg';
import SubscanSVG from '@common/assets/icons/subscan.svg';
import TelegramIconSVG from '@common/assets/icons/telegram-icon.svg';
import TransactionSVG from '@common/assets/icons/transaction.svg';
import TrashSVG from '@common/assets/icons/trash.svg';
import UploadBoxSVG from '@common/assets/icons/upload-box.svg';
import UserPlusSVG from '@common/assets/icons/user-plus.svg';
import WarningSVG from '@common/assets/icons/warning.svg';
import WarningCircleSVG from '@common/assets/icons/warning-circle.svg';
import WarningRoundedSVG from '@common/assets/icons/warning-rounded.svg';
import XeroLogoSVG from '@common/assets/icons/xero-logo.svg';
import KusamaSVG from '@common/assets/parachains-icons/kusama.svg';
import PolkadotSVG from '@common/assets/parachains-icons/polkadot.svg';
import QueueSVG from '@common/assets/icons/Queue.svg';
import PolkadotWalletSVG from '@common/assets/wallet-icons/polkadotjs-icon.svg';
import SubWalletSVG from '@common/assets/wallet-icons/subwallet-icon.svg';
import HistorySVG from '@common/assets/icons/History.svg';
import PolkassemblySVG from '@common/assets/icons/polkassembly-logo.svg';
import SubIDSVG from '@common/assets/icons/subid.svg';
import WatchIconSVG from '@common/assets/icons/watch-icon.svg';
import StarSVG from '@common/assets/icons/star-icon.svg';
import ArrowLeftCircleSVG from '@common/assets/icons/arrow-left-circle.svg';
import ArrowRightCircleSVG from '@common/assets/icons/arrow-right-circle.svg';
import TreasuryAnalyticsSVG from '@common/assets/icons/treasury-analytics-icon.svg';
import SendMoneySVG from '@common/assets/icons/money-send-circle.svg';
